...
add wave -noupdate -group mult -radix decimal {/window_func_tb/u_window_func/mult_gen[0]/u_complex_int_mult/b}
...
add wave -noupdate -expand -group mem -expand -group mem0 {/window_func_tb/u_window_func/mem_gen[0]/u_spram/addr}
add wave -noupdate -expand -group mem -expand -group mem0 {/window_func_tb/u_window_func/mem_gen[0]/u_spram/clk}
add wave -noupdate -expand -group mem -expand -group mem0 {/window_func_tb/u_window_func/mem_gen[0]/u_spram/cs}
add wave -noupdate -expand -group mem -expand -group mem0 -radix hexadecimal {/window_func_tb/u_window_func/mem_gen[0]/u_spram/data}
add wave -noupdate -expand -group mem -expand -group mem0 -radix hexadecimal {/window_func_tb/u_window_func/mem_gen[0]/u_spram/q}
add wave -noupdate -expand -group mem -expand -group mem0 {/window_func_tb/u_window_func/mem_gen[0]/u_spram/we}
add wave -noupdate -expand -group mem -expand -group mem1 -radix hexadecimal {/window_func_tb/u_window_func/mem_gen[1]/u_spram/data}
add wave -noupdate -expand -group mem -expand -group mem1 -radix hexadecimal {/window_func_tb/u_window_func/mem_gen[1]/u_spram/addr}
add wave -noupdate -expand -group mem -expand -group mem1 {/window_func_tb/u_window_func/mem_gen[1]/u_spram/we}
add wave -noupdate -expand -group mem -expand -group mem1 {/window_func_tb/u_window_func/mem_gen[1]/u_spram/cs}
add wave -noupdate -expand -group mem -expand -group mem1 -radix hexadecimal {/window_func_tb/u_window_func/mem_gen[1]/u_spram/q}
...
WaveRestoreCursors {{Cursor 1} {4725000 ps} 0}
...
update
WaveRestoreZoom {4558702 ps} {4775858 ps}
